...
namespace RestauranteCrud.Controllers
{
    public class FornecedorsController : Controller
    {
        ...
        public FornecedorsController(RestauranteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdFornecedor,NomeFornecedor,CNPJ,Telefone,Email,Endereco")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFornecedor,NomeFornecedor,CNPJ,Telefone,Email,Endereco")] Fornecedor fornecedor)
        {
